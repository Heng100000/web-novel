      ...
      <div className="relative hidden w-1/2 flex-col items-center justify-center overflow-hidden bg-zinc-900 px-12 lg:flex animate-in fade-in slide-in-from-left duration-1000">
        ...
        <div className="relative z-10 flex w-full max-w-sm flex-col gap-10">
          ...
          <div className="flex flex-col gap-4 animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-300">
            <button className="flex h-12 w-full items-center justify-center gap-3 rounded-xl border border-zinc-800 bg-zinc-800/50 text-sm font-medium text-white transition-all hover:bg-zinc-800 hover:ring-2 hover:ring-zinc-700/50 hover:scale-[1.02] active:scale-[0.98]">
        ...
        <div className="flex w-full max-w-xl flex-col gap-8">
          ...
          <div className="flex flex-col gap-4 lg:hidden">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              <button className="flex h-10 items-center justify-center gap-2 rounded-xl border border-zinc-200 bg-white text-[10px] font-bold text-zinc-700 shadow-sm transition-all hover:bg-zinc-50 active:scale-95 sm:h-12 sm:gap-3 sm:text-xs">
                <IconGoogle className="size-4 sm:size-5" />
                Google
              </button>
              <button className="flex h-10 items-center justify-center gap-2 rounded-xl border border-zinc-200 bg-white text-[10px] font-bold text-zinc-700 shadow-sm transition-all hover:bg-zinc-50 active:scale-95 sm:h-12 sm:gap-3 sm:text-xs">
                <IconFacebook className="size-4 sm:size-5 text-[#1877F2]" />
                Facebook
              </button>
            </div>
          </div>
